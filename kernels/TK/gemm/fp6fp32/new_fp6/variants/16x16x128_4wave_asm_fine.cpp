...
void micro_tk(const micro_globals g) {
    ...
    {
        constexpr int k = 0;
        G::load_once(As[toc][0], g.a, {0, 0, row*2, k+1}, global_to_shared_swizzled_offsets, 0);
        G::load_once(As[toc][0], g.a, {0, 0, row*2, k+1}, global_to_shared_swizzled_offsets, 1);
        G::load_once(As[toc][0], g.a, {0, 0, row*2, k+1}, global_to_shared_swizzled_offsets, 2);
        G::load_once(As[toc][0], g.a, {0, 0, row*2, k+1}, global_to_shared_swizzled_offsets, 3);
        G::load_once(Bs[toc][0], g.b, {0, 0, col*2, k+1}, global_to_shared_swizzled_offsets, 0);
        G::load_once(Bs[toc][0], g.b, {0, 0, col*2, k+1}, global_to_shared_swizzled_offsets, 1);
        G::load_once(Bs[toc][0], g.b, {0, 0, col*2, k+1}, global_to_shared_swizzled_offsets, 2);
        G::load_once(Bs[toc][0], g.b, {0, 0, col*2, k+1}, global_to_shared_swizzled_offsets, 3);
        G::load_once(Bs[toc][1], g.b, {0, 0, col*2+1, k+1}, global_to_shared_swizzled_offsets, 0);
        G::load_once(Bs[toc][1], g.b, {0, 0, col*2+1, k+1}, global_to_shared_swizzled_offsets, 1);
        G::load_once(Bs[toc][1], g.b, {0, 0, col*2+1, k+1}, global_to_shared_swizzled_offsets, 2);
        G::load_once(Bs[toc][1], g.b, {0, 0, col*2+1, k+1}, global_to_shared_swizzled_offsets, 3);
        G::load_once(As[toc][1], g.a, {0, 0, row*2+1, k+1}, global_to_shared_swizzled_offsets, 0);
        G::load_once(As[toc][1], g.a, {0, 0, row*2+1, k+1}, global_to_shared_swizzled_offsets, 1);
        G::load_once(As[toc][1], g.a, {0, 0, row*2+1, k+1}, global_to_shared_swizzled_offsets, 2);
        G::load_once(As[toc][1], g.a, {0, 0, row*2+1, k+1}, global_to_shared_swizzled_offsets, 3);
        ...
        addresses = get_address_fp6(B_1, b_subtile_1);
        load_fp6<0, 0>(B_1, b_subtile_1, addresses);
        load_fp6<1, 0>(B_1, b_subtile_1, addresses);
        load_fp6<2, 0>(B_1, b_subtile_1, addresses);
        load_fp6<3, 0>(B_1, b_subtile_1, addresses);
        
        auto a_subtile_1 = kittens::subtile_inplace<64, 128>(As[tic][1], {warp_row, 0});
        addresses = get_address_fp6(A_1, a_subtile_1);
        load_fp6<0, 0>(A_1, a_subtile_1, addresses);
        load_fp6<1, 0>(A_1, a_subtile_1, addresses);
        load_fp6<2, 0>(A_1, a_subtile_1, addresses);
        load_fp6<3, 0>(A_1, a_subtile_1, addresses);
        ...
        shuffle_in_place<0, 0>(B_0);
        shuffle_in_place<1, 0>(B_0);
        shuffle_in_place<2, 0>(B_0);
        shuffle_in_place<3, 0>(B_0);
        shuffle_in_place<0, 0>(B_1);
        shuffle_in_place<1, 0>(B_1);
        shuffle_in_place<2, 0>(B_1);
        shuffle_in_place<3, 0>(B_1);
        shuffle_in_place<0, 0>(A_1);
        shuffle_in_place<1, 0>(A_1);
        shuffle_in_place<2, 0>(A_1);
        shuffle_in_place<3, 0>(A_1);

        // mm_ABt(C_accum_00, B_0, A_0);
        mma_ABt<0, 0, 0>(C_accum_00, B_0, A_0);
        mma_ABt<0, 1, 0>(C_accum_00, B_0, A_0);
        mma_ABt<0, 2, 0>(C_accum_00, B_0, A_0);
        mma_ABt<0, 3, 0>(C_accum_00, B_0, A_0);
        mma_ABt<1, 0, 0>(C_accum_00, B_0, A_0);
        mma_ABt<1, 1, 0>(C_accum_00, B_0, A_0);
        mma_ABt<1, 2, 0>(C_accum_00, B_0, A_0);
        mma_ABt<1, 3, 0>(C_accum_00, B_0, A_0);
        mma_ABt<2, 0, 0>(C_accum_00, B_0, A_0);
        mma_ABt<2, 1, 0>(C_accum_00, B_0, A_0);
        mma_ABt<2, 2, 0>(C_accum_00, B_0, A_0);
        mma_ABt<2, 3, 0>(C_accum_00, B_0, A_0);
        mma_ABt<3, 0, 0>(C_accum_00, B_0, A_0);
        mma_ABt<3, 1, 0>(C_accum_00, B_0, A_0);
        mma_ABt<3, 2, 0>(C_accum_00, B_0, A_0);
        mma_ABt<3, 3, 0>(C_accum_00, B_0, A_0);

        // mma_ABt(C_accum_01, B_1, A_0);
        mma_ABt<0, 0, 0>(C_accum_01, B_1, A_0);
        mma_ABt<0, 1, 0>(C_accum_01, B_1, A_0);
        mma_ABt<0, 2, 0>(C_accum_01, B_1, A_0);
        mma_ABt<0, 3, 0>(C_accum_01, B_1, A_0);
        mma_ABt<1, 0, 0>(C_accum_01, B_1, A_0);
        mma_ABt<1, 1, 0>(C_accum_01, B_1, A_0);
        mma_ABt<1, 2, 0>(C_accum_01, B_1, A_0);
        mma_ABt<1, 3, 0>(C_accum_01, B_1, A_0);
        mma_ABt<2, 0, 0>(C_accum_01, B_1, A_0);
        mma_ABt<2, 1, 0>(C_accum_01, B_1, A_0);
        mma_ABt<2, 2, 0>(C_accum_01, B_1, A_0);
        mma_ABt<2, 3, 0>(C_accum_01, B_1, A_0);
        mma_ABt<3, 0, 0>(C_accum_01, B_1, A_0);
        mma_ABt<3, 1, 0>(C_accum_01, B_1, A_0);
        mma_ABt<3, 2, 0>(C_accum_01, B_1, A_0);
        mma_ABt<3, 3, 0>(C_accum_01, B_1, A_0);

        // mma_ABt(C_accum_10, B_0, A_1);
        mma_ABt<0, 0, 0>(C_accum_10, B_0, A_1);
        mma_ABt<0, 1, 0>(C_accum_10, B_0, A_1);
        mma_ABt<0, 2, 0>(C_accum_10, B_0, A_1);
        mma_ABt<0, 3, 0>(C_accum_10, B_0, A_1);
        mma_ABt<1, 0, 0>(C_accum_10, B_0, A_1);
        mma_ABt<1, 1, 0>(C_accum_10, B_0, A_1);
        mma_ABt<1, 2, 0>(C_accum_10, B_0, A_1);
        mma_ABt<1, 3, 0>(C_accum_10, B_0, A_1);
        mma_ABt<2, 0, 0>(C_accum_10, B_0, A_1);
        mma_ABt<2, 1, 0>(C_accum_10, B_0, A_1);
        mma_ABt<2, 2, 0>(C_accum_10, B_0, A_1);
        mma_ABt<2, 3, 0>(C_accum_10, B_0, A_1);
        mma_ABt<3, 0, 0>(C_accum_10, B_0, A_1);
        mma_ABt<3, 1, 0>(C_accum_10, B_0, A_1);
        mma_ABt<3, 2, 0>(C_accum_10, B_0, A_1);
        mma_ABt<3, 3, 0>(C_accum_10, B_0, A_1);

        // mma_ABt(C_accum_11, B_1, A_1);
        mma_ABt<0, 0, 0>(C_accum_11, B_1, A_1);
        mma_ABt<0, 1, 0>(C_accum_11, B_1, A_1);
        mma_ABt<0, 2, 0>(C_accum_11, B_1, A_1);
        mma_ABt<0, 3, 0>(C_accum_11, B_1, A_1);
        mma_ABt<1, 0, 0>(C_accum_11, B_1, A_1);
        mma_ABt<1, 1, 0>(C_accum_11, B_1, A_1);
        mma_ABt<1, 2, 0>(C_accum_11, B_1, A_1);
        mma_ABt<1, 3, 0>(C_accum_11, B_1, A_1);
        mma_ABt<2, 0, 0>(C_accum_11, B_1, A_1);
        mma_ABt<2, 1, 0>(C_accum_11, B_1, A_1);
        mma_ABt<2, 2, 0>(C_accum_11, B_1, A_1);
        mma_ABt<2, 3, 0>(C_accum_11, B_1, A_1);
        mma_ABt<3, 0, 0>(C_accum_11, B_1, A_1);
        mma_ABt<3, 1, 0>(C_accum_11, B_1, A_1);
        mma_ABt<3, 2, 0>(C_accum_11, B_1, A_1);
        mma_ABt<3, 3, 0>(C_accum_11, B_1, A_1);
    }
    tic ^= 1, toc ^= 1;
    #pragma unroll
    for (int k = 1; k < k_iters - 1; k++, tic ^= 1, toc ^= 1) {
        ...
        // mm_ABt(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<0, 0, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<0, 1, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<0, 2, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<0, 3, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<1, 0, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<1, 1, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<1, 2, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<1, 3, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<2, 0, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<2, 1, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<2, 2, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<2, 3, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<3, 0, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<3, 1, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<3, 2, 0>(C_accum_00, B_0, A_0, C_accum_00);
        mma_ABt<3, 3, 0>(C_accum_00, B_0, A_0, C_accum_00);

        // mma_ABt(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<0, 0, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<0, 1, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<0, 2, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<0, 3, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<1, 0, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<1, 1, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<1, 2, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<1, 3, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<2, 0, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<2, 1, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<2, 2, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<2, 3, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<3, 0, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<3, 1, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<3, 2, 0>(C_accum_01, B_1, A_0, C_accum_01);
        mma_ABt<3, 3, 0>(C_accum_01, B_1, A_0, C_accum_01);

        // mma_ABt(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<0, 0, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<0, 1, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<0, 2, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<0, 3, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<1, 0, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<1, 1, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<1, 2, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<1, 3, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<2, 0, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<2, 1, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<2, 2, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<2, 3, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<3, 0, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<3, 1, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<3, 2, 0>(C_accum_10, B_0, A_1, C_accum_10);
        mma_ABt<3, 3, 0>(C_accum_10, B_0, A_1, C_accum_10);

        // mma_ABt(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<0, 0, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<0, 1, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<0, 2, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<0, 3, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<1, 0, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<1, 1, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<1, 2, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<1, 3, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<2, 0, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<2, 1, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<2, 2, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<2, 3, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<3, 0, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<3, 1, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<3, 2, 0>(C_accum_11, B_1, A_1, C_accum_11);
        mma_ABt<3, 3, 0>(C_accum_11, B_1, A_1, C_accum_11);
    }
    {
