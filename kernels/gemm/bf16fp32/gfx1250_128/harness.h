/**
 * @file harness.h
 * @brief Standalone HIP host harness for gfx1250 128x128 GEMM ladder kernels.
 */
...
int main(int argc, char** argv)
{
    ...
    std::printf("gfx1250 128x128 gemm (bf16->fp32->bf16)  M=%d N=%d K=%d  iters=%d verify=%d\n",
    ...
    gemm_globals g{A_gl, B_gl, C_gl, 0};
