...
class Block(nn.Module):
    ...
    def __init__(self, config):
        ...
        elif config.FA3_kernel:
            from src.fa3_model import CausalSelfFA3Attention
            self.attn = CausalSelfFA3Attention(config)
        elif config.FA2_kernel:
            from src.fa2_model import CausalSelfFA2Attention
            self.attn = CausalSelfFA2Attention(config)
        else:
...
class GPTConfig:
    ...
    FA3_kernel: bool = False # True: use the FA3 kernel, False: use standard flash attention
    FA2_kernel: bool = False # True: use the FA2 kernel, False: use standard flash attention
    is_train: bool = False
    causal: bool = True
